    ...
    <>
      ...
      >
        <SafeAreaView style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
          ...
          <View style={[styles.card, { transform: [{ translateX: -80 }, { translateY: -200 },{ rotate: "-15deg" }], position: "absolute" }]}>
            <Image
          ...
          <View style={[styles.card, { transform: [{ translateX: 80 }, { translateY: -80 },{ rotate: "15deg" }], position: "absolute" }]}>
            <Image
